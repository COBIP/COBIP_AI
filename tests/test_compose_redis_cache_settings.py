...
_REQUIRED_RAG_COMPOSE_SNIPPETS = (
    ...
    'EMBEDDING_WARMUP_TEXT: "Spring Boot 로그인 기능템플릿 RAG warm up"',
)
...
def test_config_defaults_match_compose_skeleton_tuning() -> None:
    ...
    assert s.FEATURE_TEMPLATE_LLM_FULL_FIRST_ENABLED is True
    assert s.FEATURE_TEMPLATE_ULTRA_FAST_SKELETON_ENABLED is False
    assert s.FEATURE_TEMPLATE_FAST_SKELETON_ENABLED is False
